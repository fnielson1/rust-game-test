...
## Purpose
The JSON level file format — its schema, the meaning of a segment's endpoints and thickness, how gaps are expressed, and how malformed or missing files are handled.
